...
public class Room{  //main inspiration came from world in pong/keyboard spheres this helps facilitate operations within our room
    ...
    Area currentArea;  //stores the current area of the room
    Area areas[];  //an array of areas that make up the outside of the room
    ...
    int numAreas = 12;  //declares the size of our areas array, how many images we will hava
    Area supArea[];  //supplementary areas which are puzzles and intermediate steps
    Area previousArea;  //stores the area that we were previously in
