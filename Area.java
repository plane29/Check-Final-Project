...
public class Area extends JPanel{
	public static final int BOX_WIDTH = 960;  //BOX_WIDTH variable taken from some other lab
	public static final int BOX_HEIGHT = 640;  //BOX_HEIGHT variable taken from another lab
